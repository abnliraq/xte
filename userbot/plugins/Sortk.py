...
"""Type `.صوره` for get **All profile pics of that User**
\n Or type `.صوره (number)` to get the **desired number of photo of a User** .
"""
...
if 1 == 1:
    ...
    @borg.on(admin_cmd(pattern="صوره(.*)"))
    async def صورهcmd(event):
